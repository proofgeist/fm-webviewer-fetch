...
import FetchLibrary from "@proofgeist/fm-webviewer-fetch";
...
export default function Demo() {
  ...
  return (
    <BrowserOnly fallback={<div>Loading...</div>}>
      {() => {
        /** NOTE: this method of importing the module is only required for the docs website  */
        const { fmFetch } =
          require("@proofgeist/fm-webviewer-fetch") as typeof FetchLibrary;
        ...
        const Page = (
          <div style={{ padding: "20px", display: "grid", gap: "20px" }}>
            <div>
              ...
              <p>
                Click this button to run a FileMaker script and get the result
                back into this webpage.
              </p>
